      ...
      <article class="pb-70">
        <Article title="Info">
          ...
          <dl class="info-description-item clfix">
            ...
            <dd class="info-description-description">
              <span
                ...
                :key="`type-${ind}`"
              >
                {{ item.type_nm }}{{ item.part !==0 ? "("+item.part+"%)" : "" }}{{ ind + 1 === portfolioData.type.length ? "" : ", " }}
              </span>
            </dd>
          </dl>
          <dl class="info-description-item clfix">
            ...
            <dd class="info-description-description">
              <span
                ...
                :key="`type-${ind}`"
              >
                {{ item }}{{ ind + 1 === portfolioData.skill.length ? "" : ", " }}
              </span>
            </dd>
          </dl>
          <dl
          ...
          <dl class="info-description-item clfix" v-if="portfolioData.memo">
            ...
            <dd class="info-description-description" v-html="portfolioData.memo">
            </dd>
          </dl>
        </Article>
      </article>
